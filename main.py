...
from database import get_products, get_sales, get_stock, insert_products, insert_sales, insert_stock, check_available_stock, check_user_exists, create_user, sales_per_product, profit_per_product, sales_per_day, profit_per_day
...
app.secret_key='Abdgslelefhefffj'
...
def add_stock():
    if request.method=='POST':
        pid=request.form['pid']
        stock_quantity=request.form['st_quantity']
